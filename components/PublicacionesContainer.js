    ...
    <div className="flex flex-col gap-y-8 overflow-y-auto h-[90vh] pb-40">
      ...
      border-b-2 border-gray-800">
        ...
        <div className="flex flex-row items-center gap-x-1 ml-2">
          <Image src={"/profile.png"} height={40} width={40} alt="profile" className="rounded-full cursor-pointer" />
        ...
        <div className="mb-4">
          <Image src={"/112.jpg"} width={500} height={500} alt="proyecto" className="w-full rounded-sm"></Image>
        </div>
        ...
        <div>
          ...
          <span className="font-normal ml-1 text-sm"> El primer Portfolio relaizado con react el link para verlo es el siguiente :</span></h6>
